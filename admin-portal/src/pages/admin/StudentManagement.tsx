    ...
    <section className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Monitor registration lifecycle and blockchain identity status across
          all departments.
        </p>
      </header>
                ...
                <td className="px-6 py-4 text-muted-foreground">
                  {student.hostel ? (
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        Block {student.hostel.block} · Room{" "}
      ...
      <footer className="flex flex-wrap gap-3 text-xs text-muted-foreground">
        ...
        <span>
          Hostel residents:{" "}
          {formatNumber(students.filter((student) => student.hostel).length)}
        </span>
      </footer>
    </section>
  );
